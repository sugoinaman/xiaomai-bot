...
async def random_ding(app: Ariadne, group: Group, source: Source):
    ...
    try:
        ...
        await app.send_message(
            group, MessageChain(Graia_Image(path=save_name)), quote=source
        )
        return
...
@dispatch(Twilight([RegexMatch(r"^(随机|来[点张])[咖][波]|capoo[！!]?$")]))
